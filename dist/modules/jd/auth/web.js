...
function getCookiePathByUser(user) {
    return path.join(__dirname, '../../../../temp/', md5_1.default('cookies-jd' + user.username));
}
...
function login(user) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // 自动填写表单
        user.username && (yield page.$eval('#loginname', (el, value) => el.value = value, user.username));
        user.password && (yield page.$eval('#nloginpwd', (el, value) => el.value = value, user.password));
        if (canAutoLogin) {
...
function checkCookieStillValid(user) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const valid = (yield page.$('body[myjd="_MYJD_ordercenter"]')) !== null;
            if (valid) {
